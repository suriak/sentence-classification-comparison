...
from keras.layers import Dense, Input, Reshape, Concatenate, Flatten, Conv2D, MaxPool2D, Embedding, Dropout
...
class IntentClassifer:
    ...
    def cnn_model3(self, embedding_matrix_):
...
if __name__ == '__main__':
    ...
    for i in range(epoch):
        ...
        model, train_acc = sampleInstance.cnn_model3(embedding_matrix)
